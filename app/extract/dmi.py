...
class DMIAPI:
    ...
    def pull_datetime(self, station_id, parameter_id, limit: int = 5000, start_time: str = "2026-03-09T00:00:00Z", end_time: str ="2030-01-01T00:00:00Z"):
...
if __name__ == "__main__":
    resp = requests.get(f"""https://opendataapi.dmi.dk/v2/metObs/collections/observation/items?parameterId={parameter_id}&stationId={station_id_ballerup}&datetime={start_time}/{end_time}""")
    data = resp.json()
    temperature_values = []
    dates = []
    count=0
